...
var BrotliDecode = (function () {
  ...
  function t(e) {
    if (
      (e.t >= 16 && ((e.i = (e.o[e.s++] << 16) | (e.i >>> 16)), (e.t -= 16)),
      0 == S(e, 1))
    )
      return 16;
    var t = S(e, 3);
    return 0 != t ? 17 + t : 0 != (t = S(e, 3)) ? 8 + t : 17;
  }
  function i(e, i) {
    if (0 != e.l) throw "State MUST be uninitialized";
    ((e.h = new Int32Array(6480)), (e.input = i), z(e));
    var n = t(e);
    if (9 == n) throw "Invalid 'windowBits' code";
    ((e.p = 1 << n), (e.u = e.p - 16), (e.l = 1));
  }
  function n(e) {
    if (0 == e.l) throw "State MUST be initialized";
    11 != e.l && ((e.l = 11), null != e.input && (e.input, (e.input = null)));
  }
  function a(e) {
    if (
      (e.t >= 16 && ((e.i = (e.o[e.s++] << 16) | (e.i >>> 16)), (e.t -= 16)),
  ...
  function o(e) {
    if (
      ...
      var t = S(e, 2) + 4;
      if (7 == t) {
        if (((e.$ = 1), 0 != S(e, 1))) throw "Corrupted reserved bit";
        var i = S(e, 2);
        if (0 == i) return;
        for (n = 0; n < i; n++) {
          if (
            (e.t >= 16 &&
              ((e.i = (e.o[e.s++] << 16) | (e.i >>> 16)), (e.t -= 16)),
            0 == (a = S(e, 8)) && n + 1 == i && i > 1)
          )
        ...
        for (var n = 0; n < t; n++) {
          e.t >= 16 && ((e.i = (e.o[e.s++] << 16) | (e.i >>> 16)), (e.t -= 16));
          var a = S(e, 4);
          if (0 == a && n + 1 == t && t > 4) throw "Exuberant nibble";
          e.g |= a << (4 * n);
        }
      (e.g++, 0 == e.m && (e.P = S(e, 1)));
    }
  ...
  function s(e, t, i) {
    i.t >= 16 && ((i.i = (i.o[i.s++] << 16) | (i.i >>> 16)), (i.t -= 16));
    var n = r(e, t, i),
      a = ee[n];
    return (
      i.t >= 16 && ((i.i = (i.o[i.s++] << 16) | (i.i >>> 16)), (i.t -= 16)),
      Z[n] + (a <= 16 ? S(i, a) : E(i, a))
    );
  }
  function l(e, t, i) {
    return e < 16 ? ((i += _[e]), (i &= 3), t[i] + G[e]) : e - 16 + 1;
  }
  function c(e, t) {
    for (var i = e[t]; t > 0; t--) e[t] = e[t - 1];
    e[0] = i;
  }
  function d(e, t) {
    for (var i = new Int32Array(256), n = 0; n < 256; n++) i[n] = n;
    for (n = 0; n < t; n++) {
      var a = 255 & e[n];
      ((e[n] = i[a]), 0 != a && c(i, a));
    }
  ...
  function h(e, t, i, n) {
    var a = 0,
      ...
      l = 32768,
      c = new Int32Array(32);
    for (q(c, 0, 5, e, 18); a < t && l > 0; ) {
      (n.s > 2030 && I(n),
        n.t >= 16 && ((n.i = (n.o[n.s++] << 16) | (n.i >>> 16)), (n.t -= 16)));
      var d = (n.i >>> n.t) & 31;
      n.t += c[d] >> 16;
      var h = 65535 & c[d];
      if (h < 16)
        ((r = 0), (i[a++] = h), 0 != h && ((o = h), (l -= 32768 >> h)));
      else {
        var f = h - 14,
          p = 0;
        (16 == h && (p = o), s != p && ((r = 0), (s = p)));
        var u = r;
        (r > 0 && ((r -= 2), (r <<= f)),
          n.t >= 16 &&
            ((n.i = (n.o[n.s++] << 16) | (n.i >>> 16)), (n.t -= 16)));
        var m = (r += S(n, f) + 3) - u;
        if (a + m > t) throw "symbol + repeatDelta > numSymbols";
        for (var g = 0; g < m; g++) i[a++] = s;
        0 != s && (l -= m << (15 - s));
      }
    }
    if (0 != l) throw "Unused space";
    i.fill(0, a, t);
  }
  function f(e, t) {
    for (var i = 0; i < t - 1; ++i)
      for (var n = i + 1; n < t; ++n) if (e[i] == e[n]) return 0;
    return 1;
  }
  function p(e, t, i, n) {
    var a,
    ...
    if (
      ...
      for (
        var s = e - 1, l = 0, c = new Int32Array(4), d = S(n, 2) + 1;
        0 != s;
      ...
      switch (((r[c[0]] = 1), d)) {
        case 2:
          ...
          break;
        case 4:
          1 == S(n, 1) ? ((r[c[2]] = 3), (r[c[3]] = 3)) : (r[c[0]] = 2);
      }
      o = f(c, d);
    } else {
      for (
        var p = new Int32Array(18), u = 32, m = 0, g = a;
        g < 18 && u > 0;
        g++
      ) {
        var P = W[g];
      ...
      (0 != u && 1 != m && (o = 0), h(p, e, r, n));
    }
    if (0 == o) throw "Can't readHuffmanCode";
    q(t, i, 8, r, e);
  }
  function u(e, t, i) {
    i.s > 2030 && I(i);
    var n = a(i) + 1;
    if (1 == n) return (t.fill(0, 0, e), n);
    i.t >= 16 && ((i.i = (i.o[i.s++] << 16) | (i.i >>> 16)), (i.t -= 16));
    var o = 0;
    0 != S(i, 1) && (o = S(i, 4) + 1);
    var s = new Int32Array(1080);
    p(n + o, s, 0, i);
    for (var l = 0; l < e; ) {
      (i.s > 2030 && I(i),
        i.t >= 16 && ((i.i = (i.o[i.s++] << 16) | (i.i >>> 16)), (i.t -= 16)));
      ...
      if (0 == c) ((t[l] = 0), l++);
        ...
        i.t >= 16 && ((i.i = (i.o[i.s++] << 16) | (i.i >>> 16)), (i.t -= 16));
        for (var h = (1 << c) + S(i, c); 0 != h; ) {
          if (l >= e) throw "Corrupted context map";
          ((t[l] = 0), l++, h--);
        }
      } else ((t[l] = c - o), l++);
    }
  ...
  function m(e, t, i) {
    var n = e.v,
      a = 4 + 2 * t;
    e.t >= 16 && ((e.i = (e.o[e.s++] << 16) | (e.i >>> 16)), (e.t -= 16));
    var o = r(e.h, 1080 * t, e),
      l = s(e.h, 1080 * (t + 3), e);
    return (
      1 == o ? (o = n[a + 1] + 1) : 0 == o ? (o = n[a]) : (o -= 2),
      o >= i && (o -= i),
      (n[a] = n[a + 1]),
      (n[a + 1] = o),
      l
  ...
  function g(e) {
    e.X = m(e, 0, e.Y);
    var t = e.v[5];
    ((e.k = t << 6), (e.C = 255 & e.j[e.k]), (e.A = e.q[e.C]));
    var i = e.I[t];
    ((e.T = i << 9), (e.S = e.T + 256));
  }
  function P(e) {
    ((e.D = m(e, 1, e.F)), (e.N = e.B[e.v[7]]));
  }
  function $(e) {
    ((e.M = m(e, 2, e.U)), (e.H = e.v[9] << 2));
  }
  function b(e) {
    var t = e.p;
    if (t > e.R) {
      for (var i = e.R; t >> 1 > i; ) t >>= 1;
      0 == e.m && t < 16384 && e.p >= 16384 && (t = 16384);
    }
    if (!(t <= e.O)) {
      var n = t + 37,
        a = new Int8Array(n);
      (0 != e.L.length && a.set(e.L.subarray(0, 0 + e.O), 0),
        (e.L = a),
        (e.O = t));
    }
  }
  function v(e) {
    if (0 != e.m) return ((e.W = 10), (e._ = e.G), (e.J = 0), void (e.l = 12));
    ((e.q = new Int32Array(0)),
      (e.B = new Int32Array(0)),
      (e.V = new Int32Array(0)),
      e.s > 2030 && I(e),
      o(e),
      (0 == e.g && 0 == e.$) ||
        (0 != e.P || 0 != e.$ ? (N(e), (e.l = 0 != e.$ ? 4 : 5)) : (e.l = 2),
        0 == e.$ &&
          ((e.R += e.g), e.R > 1 << 30 && (e.R = 1 << 30), e.O < e.p && b(e))));
  }
  function y(e, t, i) {
    return i <= 1
      ? 1 << 28
  ...
  function X(e) {
    ((e.Y = a(e) + 1),
      ...
      (e.ee = (1 << e.K) - 1));
    var t = e.Z + (48 << e.K);
    e.I = new Int8Array(e.Y);
    for (var i = 0; i < e.Y; ) {
      for (var n = R(i + 96, e.Y); i < n; ++i)
        (e.t >= 16 && ((e.i = (e.o[e.s++] << 16) | (e.i >>> 16)), (e.t -= 16)),
          (e.I[i] = S(e, 2)));
      e.s > 2030 && I(e);
    }
    e.j = new Int8Array(e.Y << 6);
    var o = u(e.Y << 6, e.j, e);
    e.te = 1;
    for (var r = 0; r < e.Y << 6; r++)
      if (e.j[r] != r >> 6) {
        e.te = 0;
        break;
      }
    e.ie = new Int8Array(e.U << 2);
    var s = u(e.U << 2, e.ie, e);
    ((e.q = Q(256, o, e)),
      (e.B = Q(704, e.F, e)),
      (e.V = Q(t, s, e)),
      (e.k = 0),
  ...
  function w(e) {
    var t = e.L;
    if (e.g <= 0) return (F(e), void (e.l = 1));
    var i = R(e.O - e.G, e.g);
    if ((M(e, t, e.G, i), (e.g -= i), (e.G += i), e.G == e.O))
      return ((e.W = 5), (e._ = e.O), (e.J = 0), void (e.l = 12));
    (F(e), (e.l = 1));
  }
  function Y(e) {
    var t = R(e.ne - e.ae, e._ - e.J);
    return (
      0 != t &&
        (e.oe.set(e.L.subarray(e.J, e.J + t), e.re + e.ae),
        (e.ae += t),
        (e.J += t)),
      e.ae < e.ne ? 1 : 0
    );
  ...
  function Q(e, t, i) {
    for (var n = new Int32Array(t + 1080 * t), a = t, o = 0; o < t; o++)
      ((n[o] = a), p(e, n, a, i), (a += 1080));
    return n;
  }
  function k(e) {
    if (0 == e.l) throw "Can't decompress until initialized";
    if (11 == e.l) throw "Can't decompress after close";
    for (var t = e.O - 1, i = e.L; 10 != e.l; )
      switch (e.l) {
        case 1:
          if (e.g < 0) throw "Invalid metablock length";
          (v(e), (t = e.O - 1), (i = e.L));
          continue;
        case 2:
          (X(e), (e.l = 3));
        ...
        case 6:
          if (0 != e.te) {
            for (; e.de < e.le; )
              if (
                ...
                ((e.W = 6), (e._ = e.O), (e.J = 0), (e.l = 12));
                break;
              }
          } else
            for (
              var p = 255 & i[(e.G - 1) & t], u = 255 & i[(e.G - 2) & t];
              e.de < e.le;

            ) {
              (e.s > 2030 && I(e), 0 == e.X && g(e));
              var m = 255 & e.j[e.k + (de[e.T + p] | de[e.S + u])];
              if (
                (e.X--,
                (u = p),
                e.t >= 16 &&
          ...
          if (
            ...
            (e.se = r(
              e.V,
              e.V[255 & e.ie[e.H + (e.ce > 4 ? 3 : e.ce - 2)]],
              e,
            )),
            e.se >= e.Z)
          ) {
            ...
            e.t >= 16 &&
              ((e.i = (e.o[e.s++] << 16) | (e.i >>> 16)), (e.t -= 16));
            var k = y <= 16 ? S(e, y) : E(e, y);
            e.se = e.Z + b + ((Q + k) << e.K);
          }
          if (((e.he = l(e.se, e.v, e.fe)), e.he < 0))
            throw "Negative distance";
          if (
            (e.maxDistance != e.u && e.G < e.u
              ? (e.maxDistance = e.G)
              : (e.maxDistance = e.u),
            (e.pe = e.G),
            e.he > e.maxDistance)
          ...
          if ((e.se > 0 && ((e.v[3 & e.fe] = e.he), e.fe++), e.ce > e.g))
            ...
            if (A < 12 || (q > j && z > C))
              for (var D = 0; D < A; D += 4)
                ((i[j++] = i[C++]),
                  ...
                  (i[j++] = i[C++]),
                  (i[j++] = i[C++]));
            else i.copyWithin(j, C, q);
            ((e.de += A), (e.g -= A), (e.G += A));
          } else
            for (; e.de < e.ce; )
              if (((i[e.G] = i[(e.G - e.he) & t]), e.g--, e.de++, e.G++ == t)) {
                ((e.W = 7), (e._ = e.O), (e.J = 0), (e.l = 12));
                break;
              }
          7 == e.l && (e.l = 3);
          continue;
        case 9:
          if (!(e.ce >= 4 && e.ce <= 24)) throw "Invalid backward reference";
          var Q = V[e.ce],
            F = e.he - e.maxDistance - 1,
            B = K[e.ce],
            M = F >>> B;
          if (((Q += (F & ((1 << B) - 1)) * e.ce), !(M < 121)))
            throw "Invalid backward reference";
          var U = x(i, e.pe, L, Q, e.ce, M);
          if (((e.pe += U), (e.G += U), (e.g -= U), e.pe >= e.O)) {
            ((e.W = 8), (e._ = e.O), (e.J = 0), (e.l = 12));
            continue;
          }
          e.l = 3;
          continue;
        case 8:
          (i.copyWithin(0, e.O, e.pe), (e.l = 3));
          continue;
        case 4:
          for (; e.g > 0; )
            (e.s > 2030 && I(e),
        ...
        case 12:
          if (0 == Y(e)) return;
          (e.G >= e.u && (e.maxDistance = e.u), (e.G &= t), (e.l = e.W));
          continue;
        default:
          throw "Unexpected state " + e.l;
      }
    if (10 == e.l) {
      if (e.g < 0) throw "Invalid metablock length";
      (N(e), T(e, 1));
  ...
  function x(e, t, i, n, a, o) {
    for (
      var r = t, s = 3 * o, l = ce[se[s]], c = se[s + 1], d = ce[se[s + 2]];
      0 != le[l];
    ...
    var h = c >= 12 ? c - 11 : 0;
    (h > a && (h = a), (n += h), (a -= h));
    for (var f = (a -= c <= 9 ? c : 0); f > 0; ) ((e[r++] = i[n++]), f--);
    if (11 == c || 10 == c) {
      var p = r - a;
      for (10 == c && (a = 1); a > 0; ) {
        var u = 255 & e[p];
        u < 192
          ? (u >= 97 && u <= 122 && (e[p] ^= 32), (p += 1), (a -= 1))
          : u < 224
            ? ((e[p + 1] ^= 32), (p += 2), (a -= 2))
            : ((e[p + 2] ^= 5), (p += 3), (a -= 3));
      }
  ...
  function q(e, t, i, n, a) {
    ...
    for (r = 0; r < a; r++) l[n[r]]++;
    c[1] = 0;
    for (p = 1; p < 15; p++) c[p + 1] = c[p] + l[p];
    for (r = 0; r < a; r++) 0 != n[r] && (s[c[n[r]]++] = r);
    var d = i,
      h = 1 << d,
      f = h;
    if (1 != c[15]) {
      ((o = 0), (r = 0));
      for (var p = 1, u = 2; p <= i; p++, u <<= 1)
        for (; l[p] > 0; l[p]--)
          (j(e, t + o, u, h, (p << 16) | s[r++]), (o = C(o, p)));
      for (
        var m = f - 1, g = -1, P = t, p = i + 1, u = 2;
        p <= 15;
        p++, u <<= 1
      )
        for (; l[p] > 0; l[p]--)
          ((o & m) != g &&
            ((P += h),
            (f += h = 1 << (d = A(l, p, i))),
            (e[t + (g = o & m)] = ((d + i) << 16) | (P - t - g))),
            j(e, P + (o >> i), u, h, ((p - i) << 16) | s[r++]),
            (o = C(o, p)));
    } else for (o = 0; o < f; o++) e[t + o] = s[0];
  }
  function I(e) {
    if (0 != e.ue) {
      if (B(e) >= -2) return;
    ...
    var t = e.s << 1,
      i = 4096 - t;
    for (e.me.copyWithin(0, t, 4096), e.s = 0; i < 4096; ) {
      var n = 4096 - i,
        a = O(e.input, e.me, i, n);
      if (a <= 0) {
        ((e.ue = 1), (e.ge = i), (i += 1));
        break;
      }
  ...
  function T(e, t) {
    if (0 != e.ue) {
      var i = (e.s << 1) + ((e.t + 7) >> 3) - 4;
      if (i > e.ge) throw "Read after end";
      if (0 != t && i != e.ge) throw "Unused bytes after end";
    }
  }
  function S(e, t) {
    var i = (e.i >>> e.t) & ((1 << t) - 1);
  ...
  function E(e, t) {
    var i = S(e, 16);
    return (
      (e.i = (e.o[e.s++] << 16) | (e.i >>> 16)),
      (e.t -= 16),
      i | (S(e, t - 16) << 16)
    );
  }
  function z(e) {
    ((e.me = new Int8Array(4160)),
      (e.i = 0),
      (e.o = new Int16Array(2080)),
      (e.t = 32),
      (e.s = 2048),
      (e.ue = 0),
      D(e));
  ...
  function N(e) {
    var t = (32 - e.t) & 7;
    if (0 != t && 0 != S(e, t)) throw "Corrupted padding bits";
  }
  function B(e) {
    var t = 2048;
    return (0 != e.ue && (t = (e.ge + 1) >> 1), t - e.s);
  }
  function M(e, t, i, n) {
    if (0 != (7 & e.t)) throw "Unaligned copyBytes";
    for (; 32 != e.t && 0 != n; ) ((t[i++] = e.i >>> e.t), (e.t += 8), n--);
    if (0 != n) {
      var a = R(B(e), n >> 1);
      if (a > 0) {
        var o = e.s << 1,
          r = a << 1;
        (t.set(e.me.subarray(o, o + r), i), (i += r), (n -= r), (e.s += a));
      }
      if (0 != n)
        if (B(e) > 0) {
          for (
          ...
          for (; n > 0; ) {
            var s = O(e.input, t, i, n);
            if (-1 == s) throw "Unexpected end of input";
            ((i += s), (n -= s));
          }
    }
  }
  function U(e, t) {
    for (var i = e.me, n = t >> 1, a = e.o, o = 0; o < n; ++o)
      a[o] = (255 & i[2 * o]) | ((255 & i[2 * o + 1]) << 8);
  }
  function H() {
    ((this.L = new Int8Array(0)),
      (this.I = new Int8Array(0)),
      (this.j = new Int8Array(0)),
      (this.ie = new Int8Array(0)),
      (this.oe = new Int8Array(0)),
      (this.me = new Int8Array(0)),
      (this.o = new Int16Array(0)),
      (this.Pe = new Int32Array(0)),
      (this.v = new Int32Array(0)),
      (this.h = new Int32Array(0)),
      (this.q = new Int32Array(0)),
      (this.B = new Int32Array(0)),
      (this.V = new Int32Array(0)),
      (this.l = 0),
      (this.W = 0),
      (this.i = 0),
  ...
  function O(e, t, i, n) {
    if (null == e) return -1;
    var a = R(e.offset + n, e.data.length),
      o = a - e.offset;
    return (t.set(e.data.subarray(e.offset, a), i), (e.offset += o), o);
  }
  var L = new Int8Array(0),
    W = Int32Array.from([
      1, 2, 3, 4, 0, 5, 17, 6, 16, 7, 8, 9, 10, 11, 12, 13, 14, 15,
    ]),
    _ = Int32Array.from([3, 2, 1, 0, 3, 3, 3, 3, 3, 3, 2, 2, 2, 2, 2, 2]),
    G = Int32Array.from([0, 0, 0, 0, -1, 1, -2, 2, -3, 3, -1, 1, -2, 2, -3, 3]),
    J = Int32Array.from([
      131072, 131076, 131075, 196610, 131072, 131076, 131075, 262145, 131072,
      131076, 131075, 196610, 131072, 131076, 131075, 262149,
    ]),
    V = Int32Array.from([
    ...
    oe = Int32Array.from([0, 0, 8, 8, 0, 16, 8, 16, 16]),
    re = Int32Array.from([0, 8, 0, 8, 16, 0, 16, 8, 16]),
    se = new Int32Array(363),
    le = new Int8Array(217),
    ce = new Int32Array(51);
  !(function (e, t, i, n, a) {
    for (var o = n.length, r = 1, s = 0; s < o; ++s) {
      var l = n.charCodeAt(s);
      ((e[s] = l), 35 == l && ((t[r++] = s + 1), (e[s] = 0)));
    }
    for (s = 0; s < 363; ++s) i[s] = a.charCodeAt(s) - 32;
  })(
    le,
    ce,
    se,
  ...
  var de = new Int32Array(2048);
  !(function (e, t, i) {
    for (s = 0; s < 256; ++s)
      ((e[s] = 63 & s), (e[512 + s] = s >> 2), (e[1792 + s] = 2 + (s >> 6)));
    for (s = 0; s < 128; ++s) e[1024 + s] = 4 * (t.charCodeAt(s) - 32);
    for (s = 0; s < 64; ++s)
      ((e[1152 + s] = 1 & s), (e[1216 + s] = 2 + (1 & s)));
    for (var n = 1280, a = 0; a < 19; ++a)
      for (var o = 3 & a, r = i.charCodeAt(a) - 32, s = 0; s < r; ++s)
        e[n++] = o;
    for (s = 0; s < 16; ++s) ((e[1792 + s] = 1), (e[2032 + s] = 6));
    ((e[1792] = 0), (e[2047] = 7));
    for (s = 0; s < 256; ++s) e[1536 + s] = e[1792 + s] << 3;
  })(
    de,
    "         !!  !                  \"#$##%#$&'##(#)#++++++++++((&*'##,---,---,-----,-----,-----&#'###.///.///./////./////./////&#'# ",
    "A/*  ':  & : $  \x81 @",
  );
  var he = new Int8Array(122784);
  return (
    (function (e, t, i, n) {
      var a = t.length,
        o = i.length;
      if (a + o != e.length) throw "Corrupted brotli dictionary";
      for (var r = 0, s = 0; s < a; ++s) ((e[r] = t.charCodeAt(s)), r++);
      for (s = 0; s < o; ++s) ((e[r] = i.charCodeAt(s)), r++);
      r = 0;
      for (var l = n.length, s = 0; s < l; s += 2) {
        var c = n.charCodeAt(s) - 36,
          d = n.charCodeAt(s + 1) - 36;
        r += c;
        for (var h = 0; h < d; ++h) ((e[r] = 128 | e[r]), r++);
      }
    })(
      he,
    ...
    function (t) {
      ...
      n(a);
      for (var s = new Int8Array(o), l = 0, c = 0; c < r.length; ++c) {
        var d = r[c],
          h = R(o, l + 16384) - l;
        (h < 16384 ? s.set(d.subarray(0, h), l) : s.set(d, l), (l += h));
      }
      return s;
    }
  );
