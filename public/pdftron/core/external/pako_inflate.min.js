          ...
          ((s[254] = s[254] = 1),
            ...
            (i.buf2string = function (e, t) {
              var i,
                ...
                l = new Array(2 * f);
              for (a = 0, i = 0; i < f; )
                if (((r = e[i++]), r < 128)) l[a++] = r;
                else if (((o = s[r]), o > 4)) ((l[a++] = 65533), (i += o - 1));
                else {
        ...
        function (e, t, i) {
          ...
          function a(e, t, i, n) {
            var a = r,
              o = n + i;
            e ^= -1;
            for (var s = n; s < o; s++) e = (e >>> 8) ^ a[255 & (e ^ t[s])];
            return e ^ -1;
          }
          var r = n();
          t.exports = a;
      ...
      8: [
        function (e, t, i) {
          ...
          function r(e) {
            ...
            return e && e.state
              ? ((t = e.state),
                ...
                (t.hold = 0),
                (t.bits = 0),
                (t.lencode = t.lendyn = new _.Buf32(we)),
                (t.distcode = t.distdyn = new _.Buf32(me)),
                (t.sane = 1),
                (t.back = -1),
                z)
              : C;
          ...
          function d(e) {
            if (ge) {
              var t;
              for (m = new _.Buf32(512), k = new _.Buf32(32), t = 0; t < 144; )
                e.lens[t++] = 8;
              ...
              for (
                ...
                e.lens[t++] = 5;
              (x(E, e.lens, 0, 32, k, 0, e.work, { bits: 5 }), (ge = !1));
            }
            ((e.lencode = m),
              (e.lenbits = 9),
              (e.distcode = k),
          ...
          function u(e, t, i, n) {
            ...
            return (
              null === r.window &&
                ...
                (r.wnext = 0),
                (r.whave = 0),
                (r.window = new _.Buf8(r.wsize))),
              n >= r.wsize
                ? (_.arraySet(r.window, t, i - r.wsize, r.wsize, 0),
                  (r.wnext = 0),
                  (r.whave = r.wsize))
                : ((a = r.wsize - r.wnext),
                  a > n && (a = n),
                  _.arraySet(r.window, t, i - n, a, r.wnext),
                  (n -= a),
                  n
                    ? (_.arraySet(r.window, t, i - n, n, 0),
                      (r.wnext = n),
                      (r.whave = r.wsize))
                    : ((r.wnext += a),
            ...
            e: for (;;)
              switch (i.mode) {
                  ...
                  if (
                    ...
                    m &&
                      (i.head &&
                        ...
                        _.arraySet(i.head.extra, a, o, m, xe)),
                      512 & i.flags && (i.check = v(i.check, a, m, o)),
                      (f -= m),
                      (o += m),
                      (i.length -= m)),
                    i.length)
                    ...
                    do
                      ((xe = a[o + m++]),
                        i.head &&
                          xe &&
                          i.length < 65536 &&
                          (i.head.comment += String.fromCharCode(xe)));
                    while (xe && m < f);
                    if (
                      (512 & i.flags && (i.check = v(i.check, a, m, o)),
                      (f -= m),
                ...
                case q:
                  ...
                  ((e.adler = i.check = n(c)), (c = 0), (h = 0), (i.mode = G));
                case G:
                  if (0 === i.havedict)
                    return (
                      (e.next_out = s),
                  ...
                  ((e.adler = i.check = 1), (i.mode = X));
                case X:
                  if (t === Z || t === A) break e;
                case W:
                  if (i.last) {
                    ((c >>>= 7 & h), (h -= 7 & h), (i.mode = le));
                    break;
                  }
                  for (; h < 3; ) {
                    if (0 === f) break e;
                  ...
                  switch (((i.last = 1 & c), (c >>>= 1), (h -= 1), 3 & c)) {
                    case 0:
                      i.mode = J;
                      break;
                    case 1:
                      if ((d(i), (i.mode = ie), t === A)) {
                        ((c >>>= 2), (h -= 2));
                        break e;
                      }
                      break;
                ...
                case ee:
                  ...
                  if (
                    ...
                    (i.lenbits = 7),
                    (Se = { bits: i.lenbits }),
                    (ye = x(y, i.lens, 0, 19, i.lencode, 0, i.work, Se)),
                    (i.lenbits = Se.bits),
                    ye)
                  ) {
                ...
                case te:
                  ...
                  if (
                    ((i.lenbits = 9),
                    (Se = { bits: i.lenbits }),
                    (ye = x(S, i.lens, 0, i.nlen, i.lencode, 0, i.work, Se)),
                    (i.lenbits = Se.bits),
                    ye)
                  ) {
                ...
                case ae:
                  ...
                  ((i.was = i.length), (i.mode = re));
                case re:
                  for (
                    ;
                    (Be = i.distcode[c & ((1 << i.distbits) - 1)]),
                      (me = Be >>> 24),
                      (ke = (Be >>> 16) & 255),
                      (_e = 65535 & Be),
                      !(me <= h);
                  ...
                  if (((c >>>= me), (h -= me), (i.back += me), 64 & ke)) {
                    ((e.msg = "invalid distance code"), (i.mode = ce));
                    break;
                  }
                  ((i.offset = _e), (i.extra = 15 & ke), (i.mode = oe));
                case oe:
                  if (i.extra) {
                    for (Ee = i.extra; h < Ee; ) {
                      if (0 === f) break e;
                ...
                case se:
                  ...
                  if (((m = w - l), i.offset > m)) {
                    ...
                    (m > i.wnext
                      ? ((m -= i.wnext), (k = i.wsize - m))
                      : (k = i.wnext - m),
                      m > i.length && (m = i.length),
                      (we = i.window));
                  } else ((we = r), (k = s - i.offset), (m = i.length));
            ...
            return (
              ...
              (i.wsize ||
                (w !== e.avail_out &&
                  i.mode < ce &&
                  (i.mode < le || t !== B))) &&
              u(e, e.output, e.next_out, w - e.avail_out)
                ? ((i.mode = he), I)
                : ((b -= e.avail_in),
                  (w -= e.avail_out),
                  (e.total_in += b),
                  ...
                  i.wrap &&
                    ...
                    (e.adler = i.check =
                      i.flags
                        ? v(i.check, r, w, e.next_out - w)
                        : g(i.check, r, w, e.next_out - w)),
                  (e.data_type =
                    i.bits +
                    (i.last ? 64 : 0) +
                    (i.mode === X ? 128 : 0) +
                    (i.mode === ie || i.mode === Q ? 256 : 0)),
                  ((0 === b && 0 === w) || t === B) && ye === z && (ye = T),
                  ye)
            );
          }
          function h(e) {
          ...
          function b(e, t) {
            ...
            return e && e.state
              ? ((i = e.state),
                0 === (2 & i.wrap) ? C : ((i.head = t), (t.done = !1), z))
              : C;
          }
          function w(e, t) {
            var i,
        ...
        function (e, t, i) {
          ...
          t.exports = function (e, t, i, b, w, m, k, _) {
            var g,
              ...
              P = 0;
            for (z = 0; z <= a; z++) M[z] = 0;
            for (R = 0; R < b; R++) M[t[i + R]]++;
            for (O = A, C = a; C >= 1 && 0 === M[C]; C--);
            if ((O > C && (O = C), 0 === C))
              return (
                (w[m++] = 20971520),
                (w[m++] = 20971520),
            ...
            for (N = 1; N < C && 0 === M[N]; N++);
            for (O < N && (O = N), U = 1, z = 1; z <= a; z++)
              if (((U <<= 1), (U -= M[z]), U < 0)) return -1;
            if (U > 0 && (e === s || 1 !== C)) return -1;
            for (j[1] = 0, z = 1; z < a; z++) j[z + 1] = j[z] + M[z];
            for (R = 0; R < b; R++) 0 !== t[i + R] && (k[j[t[i + R]]++] = R);
            if (
              (e === s
                ? ((L = K = k), (S = 19))
                : e === f
                  ? ((L = d), (H -= 257), (K = u), (P -= 257), (S = 256))
                  : ((L = c), (K = h), (S = -1)),
              (F = 0),
              (R = 0),
              (z = N),
            ...
            for (;;) {
              ...
              if (z > O && (F & x) !== p) {
                for (
                  0 === T && (T = O), y += N, I = z - T, U = 1 << I;
                  I + T < C && ((U -= M[I + T]), !(U <= 0));

                )
                  (I++, (U <<= 1));
                if (((D += 1 << I), (e === f && D > r) || (e === l && D > o)))
                  return 1;
                ((p = F & x), (w[p] = (O << 24) | (I << 16) | (y - m) | 0));
              }
            }
            return (
              0 !== F && (w[y + F] = ((z - T) << 24) | (64 << 16) | 0),
              (_.bits = O),
              0
            );
          };
      ...
      "/lib/inflate.js": [
        function (e, t, i) {
          ...
          function n(e) {
            ...
            if (i !== l.Z_OK) throw new Error(d[i]);
            ((this.header = new c()),
              o.inflateGetHeader(this.strm, this.header));
          }
          function a(e, t) {
            var i = new n(t);
            if ((i.push(e, !0), i.err)) throw i.msg || d[i.err];
            return i.result;
          }
          function r(e, t) {
          ...
          ((n.prototype.push = function (e, t) {
            ...
            do {
              if (
                (0 === c.avail_out &&
                  ((c.output = new s.Buf8(b)),
                  (c.next_out = 0),
                  (c.avail_out = b)),
                (i = o.inflate(c, l.Z_NO_FLUSH)),
                i === l.Z_NEED_DICT &&
                  w &&
                  ((u =
                    "string" == typeof w
                      ...
                      : "[object ArrayBuffer]" === h.call(w)
                        ? new Uint8Array(w)
                        : w),
                  (i = o.inflateSetDictionary(this.strm, u))),
                i === l.Z_BUF_ERROR && m === !0 && ((i = l.Z_OK), (m = !1)),
                i !== l.Z_STREAM_END && i !== l.Z_OK)
              )
              ...
              (c.next_out &&
                ((0 !== c.avail_out &&
                  ...
                  ("string" === this.options.to
                    ? ((a = f.utf8border(c.output, c.next_out)),
                      (r = c.next_out - a),
                      (d = f.buf2string(c.output, a)),
                      (c.next_out = r),
                      (c.avail_out = b - r),
                      r && s.arraySet(c.output, c.output, a, r, 0),
                      this.onData(d))
