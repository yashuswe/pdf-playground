...
declare module lt.Document.SheetEditor {
  ...
  class SheetEditorActiveSheetChangedEventType extends LeadEvent {
    add(
      value: SheetEditorActiveSheetChangedEventHandler,
    ): SheetEditorActiveSheetChangedEventHandler;
  ...
  class SheetEditorSelectionChangedEventType extends LeadEvent {
    add(
      value: SheetEditorSelectionChangedEventHandler,
    ): SheetEditorSelectionChangedEventHandler;
  ...
  class SheedEditorSheetStateChangedEventType extends LeadEvent {
    add(
      value: SheedEditorSheetStateChangedEventHandler,
    ): SheedEditorSheetStateChangedEventHandler;
  ...
  class SheetEditorInteractiveEventType extends LeadEvent {
    add(
      value: SheetEditorInteractiveEventHandler,
    ): SheetEditorInteractiveEventHandler;
  ...
  class SheetEditorFactory {
    ...
    static createSheetEditorWebComponent(
      createOptions: SheetEditorCreateOptions,
    ): SheetEditor;
  }
  ...
  class SheetEditor {
    ...
    add_activeSheetChanged(
      value: SheetEditorActiveSheetChangedEventHandler,
    ): void;
    remove_activeSheetChanged(
      value: SheetEditorActiveSheetChangedEventHandler,
    ): void;
    onActiveSheetChanged(e: SheetEditorActiveSheetChangedEventArgs): void; // protected
    add_sheetStateChanged(
      value: SheedEditorSheetStateChangedEventHandler,
    ): void;
    remove_sheetStateChanged(
      value: SheedEditorSheetStateChangedEventHandler,
    ): void;
  ...
  class SheetEditorFormulaBarSearchEventType extends LeadEvent {
    add(
      value: SheetEditorFormulaBarSearchEventHandler,
    ): SheetEditorFormulaBarSearchEventHandler;
  ...
  class SheetEditorFormulaBarHelpEventType extends LeadEvent {
    add(
      value: SheetEditorFormulaBarHelpEventHandler,
    ): SheetEditorFormulaBarHelpEventHandler;
  ...
  class SheetEditorFormulaBarTextEventType extends LeadEvent {
    add(
      value: SheetEditorFormulaBarTextEventHandler,
    ): SheetEditorFormulaBarTextEventHandler;
  ...
  interface SheetEditorFormulaBarSelectionEventHandler
    extends LeadEventHandler {
    (sender: any, e: SheetEditorFormulaBarSelectionEventArgs): void;
  }

  class SheetEditorFormulaBarSelectionEventType extends LeadEvent {
    add(
      value: SheetEditorFormulaBarSelectionEventHandler,
    ): SheetEditorFormulaBarSelectionEventHandler;
  ...
  class SheetEditorFormulaBarService {
    add_formulaBarSelectionChangedEvent(
      value: SheetEditorFormulaBarSelectionEventHandler,
    ): void;
    remove_formulaBarSelectionChangedEvent(
      value: SheetEditorFormulaBarSelectionEventHandler,
    ): void;
    add_formulaBarTextChangedEvent(
      value: SheetEditorFormulaBarTextEventHandler,
    ): void;
    remove_formulaBarTextChangedEvent(
      value: SheetEditorFormulaBarTextEventHandler,
    ): void;
    add_formulaSearchEvent(
      value: SheetEditorFormulaBarSearchEventHandler,
    ): void;
    remove_formulaSearchEvent(
      value: SheetEditorFormulaBarSearchEventHandler,
    ): void;
