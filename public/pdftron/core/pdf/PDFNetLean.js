      ...
      (function (exports) {
        function optionsHelpers() {
          return {
            ...
            pushBackString: function (obj, key, value) {
              key in obj || (obj[key] = []);
              obj[key].push(value);
            },
          };
        ...
        PDFNet.Convert.CADConvertOptions.prototype.setColorMode = function (
          ...
          this.mHelpers.putString(this.mImpl, "ColorMode", "" + value);
          return this;
        };
        PDFNet.Convert.CADConvertOptions.prototype.getIncludeInvisibleLayers =
          function () {
            return "Include-invisible-layers" in this.mImpl
              ? !!this.mImpl["Include-invisible-layers"]
              : !0;
          };
        PDFNet.Convert.CADConvertOptions.prototype.setIncludeInvisibleLayers =
          function (value) {
        ...
        PDFNet.Convert.CADConvertOptions.prototype.getMaxXrefDepth =
          function () {
            return "XRef-depth" in this.mImpl ? this.mImpl["XRef-depth"] : 1e3;
          };
        ...
        PDFNet.Convert.CADConvertOptions.prototype.addSheets = function (
          ...
          this.mHelpers.pushBackString(this.mImpl, "Sheets", value);
          return this;
        };
        PDFNet.Convert.CADConvertOptions.prototype.getUnderlineTextDataFields =
          function () {
            return "Underline-text-data-fields" in this.mImpl
              ? !!this.mImpl["Underline-text-data-fields"]
              : !1;
          };
        PDFNet.Convert.CADConvertOptions.prototype.setUnderlineTextDataFields =
          function (value) {
            this.mHelpers.putBool(
              this.mImpl,
              "Underline-text-data-fields",
              value,
            );
            return this;
          };
