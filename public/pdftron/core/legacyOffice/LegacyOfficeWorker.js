            ...
            if (!gt || gt !== e) {
              if (
                ...
                (Ke = w(e, "FORBID_CONTENTS")
                  ...
                  : Ze),
                (Me = w(e, "FORBID_TAGS") ? x({}, e.FORBID_TAGS, ht) : O({})),
                (Le = w(e, "FORBID_ATTR") ? x({}, e.FORBID_ATTR, ht) : O({})),
          ...
          It = function (e) {
            ...
            for (; o--; ) {
              ...
              if (
                ...
                (d = n.attrValue),
                !Ye || ("id" !== u && "name" !== u) || (_t(a, e), (d = Xe + d)),
                Ue && A(/((--!?|])>)|<\/(style|title)/i, d))
              ) {
                _t(a, e);
                continue;
              }
              ...
              if (Lt(p, u, d)) {
                ...
                if (d !== f)
                  try {
                    (c ? e.setAttributeNS(c, a, d) : e.setAttribute(a, d),
  ...
  function (e, t, n) {
    ...
    function C(e, t, n, r) {
      return (function e(t, n, r, o, i, a, c) {
        ...
        function (e) {
          return (
            "WASM compilation took ".concat(Date.now() - void 0, " ms"),
            e
          );
        },
      );
