      ...
      var a = {
        insert: function (o) {
          ...
          ((n = document.getElementsByTagName("apryse-webviewer")),
            n.length ||
              (n = (function o(n, e = document) {
                const i = [];
                return (
                  e.querySelectorAll(n).forEach((o) => i.push(o)),
                  e.querySelectorAll("*").forEach((e) => {
                    e.shadowRoot && i.push(...o(n, e.shadowRoot));
                  }),
                  i
                );
              })("apryse-webviewer")));
          ...
          for (let i = 0; i < n.length; i++) {
            ...
            if (0 === i)
              ...
              (t.shadowRoot.appendChild(n), e.push(n));
            }
          }
        },
        singleton: !1,
    ...
    2132: function (o, n, e) {
      ...
      var i = e(0),
        ...
        c =
          (e(2e3),
          function () {
            var o = Object(a.e)(function (o) {
                return r.a.isElementOpen(o, s.a.LOADING_MODAL);
              }, a.c),
              n = Object(a.e)(function (o) {
                return r.a.isElementDisabled(o, s.a.LOADING_MODAL);
              }, a.c),
              e = Object(a.d)();
            return (
              Object(i.useEffect)(
              ...
              n
                ...
                : t.a.createElement(
                    "div",
                    {
                      className: p()({ Modal: !0, LoadingModal: !0, open: o }),
                      "data-element": s.a.LOADING_MODAL,
                    },
                    t.a.createElement(
                      "div",
                      { className: "container" },
                      t.a.createElement("div", { className: "inner-wrapper" }),
                    ),
                  )
            );
          });
