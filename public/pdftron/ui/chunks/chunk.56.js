(window.webpackJsonp = window.webpackJsonp || []).push([
  [56],
  {
        ...
        insert: function (n) {
          ...
          ((t = document.getElementsByTagName("apryse-webviewer")),
            t.length ||
              (t = (function n(t, e = document) {
                const i = [];
                return (
                  e.querySelectorAll(t).forEach((n) => i.push(n)),
                  e.querySelectorAll("*").forEach((e) => {
                    e.shadowRoot && i.push(...n(t, e.shadowRoot));
                  }),
                  i
                );
              })("apryse-webviewer")));
          ...
          for (let i = 0; i < t.length; i++) {
            ...
            if (0 === i)
              ...
              (o.shadowRoot.appendChild(t), e.push(t));
            }
          }
        },
        singleton: !1,
    ...
    2106: function (n, t, e) {
      ...
      var A = {
          alignmentConfig: d.a.array,
          alignmentOnClick: d.a.func,
          backToMenuOnClick: d.a.func,
          distributeConfig: d.a.array,
          distributeOnClick: d.a.func,
          isAnnotation: d.a.bool,
        },
        y = function (n) {
          var t = n.alignmentConfig,
            e = n.alignmentOnClick,
            i = n.backToMenuOnClick,
            o = n.distributeConfig,
            r = n.distributeOnClick,
            l = n.isAnnotation,
            c = f(Object(g.a)(), 1)[0],
            u = function (n, t, e) {
              return p.a.createElement(
                ...
                p.a.createElement("div", null, c(n)),
                p.a.createElement(
                  "div",
          ...
          return l
            ? p.a.createElement(
                ...
                p.a.createElement(
                  ...
                  p.a.createElement("div", { className: "divider" }),
                  u("alignmentPopup.alignment", t, e),
                  u("alignmentPopup.distribute", o, r),
                ),
              )
            : null;
        };
      ...
      var w = y,
        v = e(60),
        x = e(5),
        P = r.a.getAnnotationManager(),
        O = P.Alignment.StandardAlignmentTypes,
        C = O.LEFT,
        T = O.RIGHT,
        k = O.TOP,
        E = O.BOTTOM,
        j = P.Alignment.CenterAlignmentTypes,
        N = j.CENTER_VERTICAL,
        I = j.CENTER_HORIZONTAL,
        S = P.Alignment.DistributeAlignmentTypes,
        B = S.DISTRIBUTE_VERTICAL,
      ...
      var G = { annotation: d.a.object },
        W = function (n) {
          var t = n.annotation,
            e = U(
              Object(c.e)(function (n) {
                return [
                  m.a.isElementOpen(n, x.a.ANNOTATION_ALIGNMENT_POPUP),
                  m.a.getActiveDocumentViewerKey(n),
                ];
              }, c.c),
              2,
            ),
            o = e[0],
            s = e[1],
            d = U(Object(l.useState)({ left: 0, top: 0 }), 2),
            g = d[0],
            b = d[1],
            f = Object(l.useRef)(),
            h = Object(c.d)();
          ...
          var A = function () {
              t && f.current && b(Object(u.c)(t, f, s));
            },
            y = a()({
              Popup: !0,
              AlignAnnotationPopupContainer: !0,
              open: o,
              closed: !o,
            }),
            P = void 0 !== t;
          return p.a.createElement(
            v.a,
            {
              dataElement: x.a.ANNOTATION_ALIGNMENT_POPUP,
              className: y,
              style: H({}, g),
              ref: f,
            },
            p.a.createElement(w, {
              alignmentConfig: M,
              alignmentOnClick: function (n) {
                var t = r.a.getAnnotationManager(),
                  e = t.getSelectedAnnotations();
                ("centerHorizontal" === n || "centerVertical" === n
                  ? t.Alignment.centerAnnotations(e, n)
                  : t.Alignment.alignAnnotations(e, n),
                  A());
              },
              backToMenuOnClick: function () {
                h(i.a.closeElement(x.a.ANNOTATION_ALIGNMENT_POPUP));
                var n = r.a.getAnnotationManager(),
                  t = n.getSelectedAnnotations();
                n.selectAnnotations(t);
              },
              distributeConfig: R,
              distributeOnClick: function (n) {
                var t = r.a.getAnnotationManager(),
                  e = t.getSelectedAnnotations();
                (t.Alignment.distributeAnnotations(e, n), A());
              },
              isAnnotation: P,
            }),
          );
