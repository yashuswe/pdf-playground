  ...
  [12],
  {
    1409: function (A, e, t) {
      ...
      var i = function (A, e) {
        ...
        return (0, a.renderElement)(A, r({}, F, t), o);
      };
        ...
        i = (function () {
          function A(e) {
            ...
            var t,
              ...
              Q = i[2],
              w = i[3];
            ((this.r = l), (this.g = u), (this.b = Q), (this.a = w));
          }
          return (
            n(A, [
              {
        ...
        i =
          ...
          (e.parseBoundCurves = function (A, e, t) {
            ...
            return {
              ...
              bottomRightOuter:
                o > 0 || l > 0
                  ? c(A.left + F, A.top + C, o, l, i.BOTTOM_RIGHT)
                  : new n.default(A.left + A.width, A.top + A.height),
              bottomRightInner:
                o > 0 || l > 0
                  ? c(
                      A.left + Math.min(F, A.width - e[3].borderWidth),
              ...
              bottomLeftOuter:
                u > 0 || Q > 0
                  ? c(A.left, A.top + d, u, Q, i.BOTTOM_LEFT)
    ...
    1714: function (A, e, t) {
        ...
        S = (function () {
          function A(e, t, r, n) {
            ...
            var s = e.ownerDocument.defaultView,
              ...
              R = (0, h.parsePosition)(D.position);
            if (
              ((this.style = {
                background: O
                  ? v.INPUT_BACKGROUND
                ...
                zIndex: (0, T.parseZIndex)(
                  R !== h.POSITION.STATIC ? D.zIndex : "auto",
                ),
              }),
              this.isTransformed() &&
            ...
            ("IMG" === e.tagName &&
              ...
              (this.image = L(e, r)),
              (this.bounds = O
                ? (0, v.reformatInputBounds)((0, m.parseBounds)(e, S, _))
      ...
      var L = function (A, e) {
        if (
          ...
          var t = (0, m.parseBounds)(A, 0, 0);
          (A.setAttribute("width", t.width + "px"),
            A.setAttribute("height", t.height + "px"));
          var r = new XMLSerializer();
          return e.loadImage(
            "data:image/svg+xml," + encodeURIComponent(r.serializeToString(A)),
          );
        }
        switch (A.tagName) {
          case "IMG":
          ...
          case "CANVAS":
            var B = A;
            return e.loadCanvas(B);
          case "IFRAME":
            var a = A.getAttribute("data-html2canvas-internal-iframe-key");
            if (a) return a;
        }
        return null;
      };
      ...
      var c = (e.BACKGROUND_REPEAT = {
        ...
        d = function (A, e) {
          ...
          return t.map(function (A, e) {
            var t = (B[e] || "auto").trim().split(" ").map(E),
              a = (r[e] || "auto").trim().split(" ").map(h);
            return {
              source: A,
      ...
      var r = t(1857),
        ...
        B = {
          get SUPPORT_RANGE_BOUNDS() {
            ...
            return (
              Object.defineProperty(B, "SUPPORT_RANGE_BOUNDS", { value: A }),
              A
            );
          },
          get SUPPORT_SVG_DRAWING() {
            ...
            return (
              Object.defineProperty(B, "SUPPORT_SVG_DRAWING", { value: A }),
              A
            );
          },
          ...
          get SUPPORT_CORS_IMAGES() {
            ...
            return (
              Object.defineProperty(B, "SUPPORT_CORS_IMAGES", { value: A }),
              A
            );
          },
          get SUPPORT_RESPONSE_TYPE() {
            ...
            return (
              Object.defineProperty(B, "SUPPORT_RESPONSE_TYPE", { value: A }),
              A
            );
          },
          get SUPPORT_CORS_XHR() {
            ...
            return (
              Object.defineProperty(B, "SUPPORT_CORS_XHR", { value: A }),
              A
            );
          },
        };
    ...
    1788: function (A, e, t) {
      ...
      var i = ["OL", "UL", "MENU"],
              ...
              if (u)
                ...
                "number" == typeof e.listIndex &&
                  ((c = A.ownerDocument.createTextNode(
                    d(e.listIndex, s.listStyleType, !0),
                  )),
                  i.appendChild(c),
                  (i.style.top = e.bounds.top - l + "px"));
        ...
        F = function (A, e, t, n, B, s) {
          if (A < -9999 || A > 9999)
            return d(A, a.LIST_STYLE_TYPE.CJK_DECIMAL, B.length > 0);
          var o = Math.abs(A),
            i = B;
          if (0 === o) return e[0] + i;
        ...
        d = (e.createCounterText = function (A, e, t) {
          var r = t ? ". " : "",
            n = t ? "、" : "",
            B = t ? ", " : "";
          switch (e) {
            ...
            for (
              var r =
                  0 !== e.style.letterSpacing
                    ? (0, o.toCodePoints)(A).map(function (A) {
    ...
    1860: function (A, e, t) {
      ...
      e.Proxy = function (A, e) {
        ...
        return new Promise(function (r, n) {
          var a =
              B.default.SUPPORT_CORS_XHR && B.default.SUPPORT_RESPONSE_TYPE
                ? "blob"
                : "text",
          ...
          return s
            ...
            : (0, i.cloneWindow)(w, U, e, t, Q, A).then(function (A) {
                ...
                var i = (0, n.NodeParser)(s, o, Q),
                  u = s.ownerDocument;
                return (
                  F === i.container.style.background.backgroundColor &&
          ...
          for (var U, g = e.firstChild; g; g = U) {
            ...
            if (
              ...
              if (-1 === c.indexOf(g.nodeName)) {
                var F = new n.default(g, t, l, w++);
                if (F.isVisible()) {
                  "INPUT" === g.tagName
                    ? (0, a.inlineInputElement)(g, F)
                    : "TEXTAREA" === g.tagName
                      ? (0, a.inlineTextAreaElement)(g, F)
                      : "SELECT" === g.tagName
                        ? (0, a.inlineSelectElement)(g, F)
                        : F.style.listStyle &&
                          F.style.listStyle.listStyleType !==
                            o.LIST_STYLE_TYPE.NONE &&
                          (0, s.inlineListItemElement)(g, F, l);
                  var d = "TEXTAREA" !== g.tagName,
                    E = u(F, g);
                  if (E || Q(F)) {
                    var h =
                        E || F.isPositioned()
                          ...
                          : i,
                      f = new r.default(F, h, E);
                    (h.contexts.push(f), d && A(g, F, f, l, w));
                  } else (i.children.push(F), d && A(g, F, i, l, w));
                }
              }
            } else if (
    ...
    1898: function (A, e, t) {
      ...
      var c = (e.LETTER_NUMBER_MODIFIER = 50),
        ...
        W = function (A, e, t, r, n) {
          ...
          if (Y(B, e) === d) return D;
          if (G(23, d, B, e)) return D;
          if (G([w, U], F, B, e)) return D;
          if (G(12, 12, B, e)) return D;
          if (o === l) return M;
          if (23 === o || 23 === c) return D;
          if (16 === c || 16 === o) return M;
          if (-1 !== [u, Q, F].indexOf(c) || 14 === o) return D;
          if (36 === i && -1 !== x.indexOf(o)) return D;
          if (o === p && 36 === c) return D;
          if (c === C && -1 !== R.concat(C, g, h, v, I, K).indexOf(o)) return D;
          if (
            (-1 !== R.indexOf(c) && o === h) ||
            (-1 !== R.indexOf(o) && c === h)
          )
          ...
          if (
            (-1 !== [H, f].indexOf(o) &&
              (c === h || (-1 !== [d, Q].indexOf(c) && e[s + 1] === h))) ||
            (-1 !== [d, Q].indexOf(o) && c === h) ||
            (o === h && -1 !== [h, p, E].indexOf(c))
          )
            return D;
          if (-1 !== [h, p, E, w, U].indexOf(c))
            for (var N = B; N >= 0; ) {
              var L = e[N];
              if (L === h) return D;
          ...
          if (-1 !== [H, f].indexOf(c))
            for (var k = -1 !== [w, U].indexOf(o) ? a : B; k >= 0; ) {
              var J = e[k];
              if (J === h) return D;
          ...
          if (
            (b === o && -1 !== [b, y, T, m].indexOf(c)) ||
            (-1 !== [y, T].indexOf(o) && -1 !== [y, S].indexOf(c)) ||
            (-1 !== [S, m].indexOf(o) && c === S)
          )
            return D;
          if (
            (-1 !== V.indexOf(o) && -1 !== [C, f].indexOf(c)) ||
            (-1 !== V.indexOf(c) && o === H)
          )
            return D;
          ...
          if (
            (-1 !== R.concat(h).indexOf(o) && c === d) ||
            (-1 !== R.concat(h).indexOf(c) && o === U)
          )
            return D;
          if (41 === o && 41 === c) {
    ...
    1899: function (A, e, t) {
      ...
      var B = (e.UTRIE2_SHIFT_2 = 5),
        ...
        F = (e.UTRIE2_INDEX_2_BLOCK_LENGTH = 1 << o),
        d = (e.UTRIE2_INDEX_2_MASK = F - 1),
        E =
    ...
    1903: function (A, e, t) {
      ...
      var l = /^(to )?(left|top|right|bottom)( (left|top|right|bottom))?$/i,
        ...
        d = (e.LinearGradient = function A(e, t) {
          (c(this, A),
          ...
          ((e.parseGradient = function (A, e, t) {
            ...
            return "linear-gradient" === n
              ...
              : "gradient" === n && "linear" === r[0]
                ? f(["to bottom"].concat(b(r.slice(3))), t, !!B)
                : "radial-gradient" === n
            ...
            for (
              ...
              if (null !== w) {
                ...
                if (null === g) {
                  ...
                  for (var F = C - U + 1, d = (u[C].stop - w) / F; U < C; U++)
                    w = u[U].stop = w + d;
                } else w = g;
              }
            return u;
        ...
        H = function (A, e, t) {
          ...
          return new E(h(e, r ? 1 : 0, Math.min(i.x, i.y)), n, o, i);
        },
        p = function (A, e) {
          var t = e.width,
            r = e.height,
              ...
              },
              {
                ...
                value: function (A) {
                  ...
                  if (
                    ...
                    var l = [].slice.call(A.sheet.cssRules, 0).reduce(function (
                        A,
                        e,
                      ) {
                        return A + e.cssText;
              ...
              },
              {
                ...
                value: function (A) {
                  ...
                  (this.referenceElement === A &&
                    ...
                    e instanceof t.HTMLBodyElement && f(e));
                  for (
                  ...
                  if (
                    ...
                    switch (
                      (n && this.inlineAllImages(C(A, e, n, s, F)),
                      B && this.inlineAllImages(C(A, e, B, c, d)),
                      !r ||
                        !this.copyStyles ||
                      ...
                      case "SELECT":
                        ...
                        break;
                      case "INPUT":
                        A.checked && e.setAttribute("checked", !0);
                    }
                  return e;
                },
              },
        ...
        C = function (A, e, t, r, n) {
          if (
            ...
            return (
              (B.className = E + " " + h),
              (e.className += n === F ? " " + E : " " + h),
              n === F ? e.insertBefore(B, e.firstChild) : e.appendChild(B),
              B
            );
          }
        },
          ...
          (e.resolvePseudoContent = function (A, e, t) {
            ...
            if (Q && "none" !== Q) {
              var w = Q.split(/\s+/),
                ...
                C = U[1],
                F = t.counters[g];
              F && (F[F.length - 1] += void 0 === C ? 1 : parseInt(C, 10));
            }
            for (var d = 0; d < B; d++) {
              var E = n[d];
              switch (E.type) {
                ...
                case s.COUNTER:
                  ...
                  h && (u += l([h[h.length - 1]], "", E.format));
                  break;
                case s.COUNTERS:
                  var f = t.counters[E.name || ""];
                  f && (u += l(f, E.glue, E.format));
                  break;
                case s.OPENQUOTE:
                ...
                case s.URL:
                  (u && (i.push({ type: a.TEXT, value: u }), (u = "")),
                    i.push({ type: a.IMAGE, value: E.value || "" }));
              }
            }
...
//# sourceMappingURL=chunk.vendors.html2canvas.js.map
