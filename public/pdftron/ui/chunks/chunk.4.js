    ...
    1584: function (e, t, n) {
      ...
      var o = function (e, t, n) {
          return {
            ...
            title: n,
            option: e,
            dataElement: "".concat(e[0].toUpperCase() + e.slice(1), "Button"),
          };
        },
        i = {
          OPENFILE: "openFile",
        ...
        r = [
          o(i.OPENFORMFIELDPANEL, "icon-edit-form-field", "action.edit"),
          o(i.OPENFILE, "icon-portfolio-file", "portfolio.openFile"),
          o(i.RENAME, "ic_edit_page_24px", "action.rename"),
          o(i.SETDEST, "icon-thumbtack", "action.setDestination"),
          o(i.DOWNLOAD, "icon-download", "action.download"),
          o(i.DELETE, "icon-delete-line", "action.delete"),
          o(i.MOVE_UP, "icon-page-move-up", "action.moveUp"),
          o(i.MOVE_DOWN, "icon-page-move-down", "action.moveDown"),
          o(i.MOVE_LEFT, "icon-page-move-left", "action.moveLeft"),
          o(i.MOVE_RIGHT, "icon-page-move-right", "action.moveRight"),
        ];
    },
    1656: function (e, t, n) {
      "use strict";
      ...
      var b = function (e, t) {
        var n = f(Object(o.useState)(1), 2),
          i = n[0],
          r = n[1];
        return (
          Object(o.useEffect)(
            function () {
              for (var n = -1, o = null == e ? void 0 : e.current; o; )
                (n++, (o = o.parentElement.closest(t)));
              r(n);
            },
            [e],
          ),
      ...
      var E = function (e, t, n, o, i) {
              ...
              w(
                w(
                  w(
                    ...
                    i.OPENFORMFIELDPANEL,
                    function () {
                      return ["portfolio", "bookmark", "outline"].includes(t);
                    },
                  ),
                  i.MOVE_LEFT,
                  function () {
          ...
          return e.map(function (e) {
            ...
            return y(
              ...
              {
                hidden: i,
                dataElement: "".concat(t).concat(e.dataElement),
                onClick: function () {
                  return o(e.option);
                },
              },
      ...
      var N = i.a.memo(function (e) {
        ...
        return i.a.createElement(
          ...
          t &&
            i.a.createElement(
              "div",
              { className: "panel-list-icon-container" },
              i.a.createElement(m.a, { glyph: t }),
            ),
          i.a.createElement(
            "div",
            { className: "panel-list-text-container" },
            i.a.createElement(
              "div",
              { className: "panel-list-label-header" },
              i.a.createElement(p.a, {
                style: { color: a || "inherit" },
                ariaLabel: n,
                label: n,
                onDoubleClick: o,
                onClick: r,
                className: c()({ "set-focus": s }),
                useI18String: l,
              }),
            ),
          ),
      ...
      ((N.displayName = "PanelItemContent"),
        (N.propTypes = {
          iconGlyph: l.a.string,
          labelHeader: l.a.string.isRequired,
          onDoubleClick: l.a.func,
          onClick: l.a.func,
          useI18String: l.a.bool,
          textColor: l.a.string,
          isActive: l.a.bool,
        }));
      var M = function (e) {
        var t = e.checkboxOptions,
          n = e.children,
          r = e.contentMenuFlyoutOptions,
          l = void 0 === r ? {} : r,
          a = e.contextMenuMoreButtonOptions,
          m = void 0 === a ? {} : a,
          f = e.description,
          h = e.enableMoreOptionsContextMenuFlyout,
          g = e.iconGlyph,
          v = e.labelHeader,
          y = e.useI18String,
          w = void 0 === y || y,
          ...
          I = e.expanded,
          P = e.setIsExpandedHandler,
          T = e.textColor,
          F = e.isActive,
          L = Object(o.useRef)(),
          R = b(L),
          _ = S(Object(o.useState)(null != I && I), 2),
          B = _[0],
          H = _[1],
          V = Object(s.a)().t,
          G = Object(O.d)(),
          U = l.shouldHideDeleteButton,
          W = void 0 !== U && U,
          q = l.currentFlyout,
          z = l.flyoutSelector,
          J = l.type,
          $ = l.handleOnClick,
          K = m.flyoutToggleElement,
          Q = m.moreOptionsDataElement,
          X = (t && !t.disabled) || !1;
        Object(o.useEffect)(
          function () {
            H(I);
          ...
          i.a.createElement(
            "div",
            {
              className: c()({
                ...
                "grid-with-2-rows": f,
                "grid-with-1-row": !f,
                "grid-with-3-columns": !g && !t,
                "grid-with-4-columns": g || t,
                "grid-with-5-columns": g && t,
              }),
            },
            i.a.createElement(
              "div",
              {
                className: c()(
                  "panel-list-row".concat(t ? " with-checkbox" : ""),
                  "focusable-container",
                ),
              },
              X &&
                i.a.createElement(
                  "div",
                  {
                    style: { "--checkbox-left": "".concat(-32 * R + 4, "px") },
                    className: "checkbox",
                  },
                  i.a.createElement(d.a, {
                    role: "checkbox",
                    id: null == t ? void 0 : t.id,
                    "aria-label": null == t ? void 0 : t.ariaLabel,
                    "aria-checked": null == t ? void 0 : t.checked,
                    checked: null == t ? void 0 : t.checked,
                    onChange: null == t ? void 0 : t.onChange,
                  }),
                ),
              i.a.createElement(
                "div",
                {
                  onClick: function (e) {
                    (e.stopPropagation(), H(!B), P && P(!B));
                  },
                  className: c()({
                    "chevron-container": !0,
                    toggled: B,
                    visible: n && n.length > 0,
                  }),
                },
                i.a.createElement(p.a, {
                  ...
                  ariaExpanded: B,
                  ariaLabel: ""
                    .concat(V(B ? "action.collapse" : "action.expand"), " ")
                    .concat(v),
                }),
              ),
              i.a.createElement(N, {
              ...
              h &&
                i.a.createElement(
                  "div",
                  { className: "panel-list-more-options" },
                  i.a.createElement(u.a, {
                    className: "toggle-more-button",
                    title: ""
                      .concat(V("option.searchPanel.moreOptions"), " ")
                      .concat(v),
                    toggleElement: K,
                    dataElement: Q,
                    img: "icon-tool-more",
                    ...
                    onClick: function (e) {
                      ...
                      (G(q ? k.a.updateFlyout(z, t) : k.a.addFlyout(t)),
                        G(k.a.setFlyoutToggleElement(Q)),
                        G(k.a.toggleElement(z)));
                    },
                  }),
                ),
            ),
            f &&
              i.a.createElement(
                "div",
                { className: "panel-list-description" },
                f,
              ),
          ),
          B && i.a.createElement(D, null, n),
        );
      };
      M.propTypes = {
        checkboxOptions: l.a.shape({
          id: l.a.string,
          checked: l.a.bool,
          onChange: l.a.func,
        ...
        enableMoreOptionsContextMenuFlyout: l.a.bool,
        children: l.a.node,
        onDoubleClick: l.a.func,
        onClick: l.a.func,
        expanded: l.a.bool,
        textColor: l.a.string,
        setIsExpandedHandler: l.a.func,
        contentMenuFlyoutOptions: l.a.shape({
          shouldHideDeleteButton: l.a.bool,
          currentFlyout: l.a.object,
          flyoutSelector: l.a.string,
          type: l.a.string,
          handleOnClick: l.a.func,
        }),
        contextMenuMoreButtonOptions: l.a.shape({
          flyoutToggleElement: l.a.string,
          moreOptionsDataElement: l.a.string,
        }),
        isActive: l.a.bool,
      };
      t.a = M;
